...
export default function Footer() {
  return (
    <footer className="mt-20 px-4 pb-6 md:px-8">
      <div className="glass-card rounded-2xl px-6 py-8 md:px-10 md:py-10 max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-xs text-text-secondary leading-relaxed max-w-xs">
              Fair, transparent electricity bill splitting for families sharing
              one meter — built for Afghanistan.
            </p>
            <a
              href={GITHUB_URL}
              target="_blank"
        ...
        <div className="border-t border-glass-border mt-8 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-text-secondary">Made for Afghanistan 🇦🇫</p>
        </div>
      </div>
    </footer>
  );
